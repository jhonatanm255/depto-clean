...
export default function DashboardPage() {
  ...
  if (!currentUser) {
    // This case should ideally be handled by the (app)/layout.tsx redirecting to /login.
    // Displaying a spinner here is a fallback if this component renders before redirection.
    return (
      <div className="flex flex-grow items-center justify-center bg-background">
        <LoadingSpinner size={48} />
      </div>
